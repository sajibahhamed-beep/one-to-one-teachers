...
import { Award, UserPlus, ArrowRight, ShieldCheck, HeartHandshake } from "lucide-react";
        ...
        <div className="max-w-[1140px] mx-auto px-6 md:px-8">
          <div className="text-center max-w-2xl mx-auto mb-14 space-y-3">
            <h2 className="font-sans text-3xl sm:text-4xl font-extrabold text-[#0D2C4A]">
              {lang === "bn" ? "কেন OTOTeachers-এ শিক্ষক হিসেবে যুক্ত হবেন?" : "Why Join OTOTeachers as a Teacher?"}
            </h2>
