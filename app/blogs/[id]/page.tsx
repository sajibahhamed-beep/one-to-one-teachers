  ...
  const post = useMemo(() => {
    ...
    if (apiMatch) {
      return {
        ...
        excerptBn: apiMatch.excerptBn || "ototeachers.com প্ল্যাটফর্মের ১-অন-১ টিচিং দিকনির্দেশনা।",
        excerptEn: apiMatch.excerptEn || "1-on-1 guidance from ototeachers.com platform.",
