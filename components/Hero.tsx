    ...
    <section className="hero relative bg-[#F4F9F9] text-[#0D2C4A] pt-14 pb-20 font-sans border-b border-[#00A896]/15">
      <div className="max-w-[1240px] mx-auto px-6 md:px-8 grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-center">
        ...
        <div className="lg:col-span-7 space-y-5">
          {/* Title */}
          <h1 className="font-sans text-4xl sm:text-5xl lg:text-6xl font-extrabold text-[#0D2C4A] tracking-tight leading-[1.35] mb-6">
            {t.heroTitlePart1}{" "}
          ...
          <div className="flex flex-wrap items-center gap-4 pt-2">
            <button
              ...
              className="flex items-center gap-2.5 px-8 py-3.5 rounded-full bg-[#00A896] text-white font-bold text-sm hover:bg-[#008075] shadow-lg shadow-[#00A896]/30 hover:-translate-y-0.5 transition-all cursor-pointer select-none"
            >
            ...
            <Link
              href="/about"
              className="flex items-center gap-2 px-7 py-3.5 rounded-full bg-[#E6F4F3] text-[#0D2C4A] font-bold text-sm hover:bg-[#D4ECE9] transition-colors cursor-pointer border border-[#00A896]/15 select-none"
            >
        ...
        <div className="lg:col-span-5 flex flex-col gap-5">
          ...
          <div
            onClick={() => onOpenEnroll?.()}
            className="relative rounded-3xl overflow-hidden shadow-xl border border-[#00A896]/20 aspect-[4/3] group bg-white p-2 cursor-pointer hover:shadow-2xl transition-all"
          >
            <div className="relative w-full h-full rounded-2xl overflow-hidden">
              ...
              {/* Badge */}
              <div className="absolute top-4 left-4 bg-[#02554d] text-white px-4 py-1.5 rounded-full text-xs font-bold flex items-center gap-2 shadow-md">
                <ShieldCheck className="w-4 h-4 text-white" />
                <span>{lang === "bn" ? "১-অন-১ ভেরিফাইড টিচার" : "1-on-1 Verified Teacher"}</span>
              </div>

              {/* Text on Image */}
              <div className="absolute bottom-5 left-5 right-5 text-white space-y-1">
                <p className="font-sans text-lg font-bold leading-[1.38] text-white drop-shadow-md">
                  {lang === "bn"
